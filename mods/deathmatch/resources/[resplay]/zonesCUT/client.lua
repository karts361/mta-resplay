			...
			if p and isElement(p) then
				...
				if getElementData(p, "greenzone") then
					...
					if getDistanceBetweenPoints3D(lpos[1], lpos[2], lpos[3], ppos[1], ppos[2], ppos[3]) <= 20 then
						...
						if x and y then
							dxDrawText("Resplay: Вы в зелёной зоне", x+1, y+1, x, y, tocolor(0, 0, 0), 0.5, "bankgothic", "center")
							dxDrawText("Resplay: Вы в зелёной зоне", x, y, x, y, tocolor(0, 220, 0), 0.5, "bankgothic", "center")
						end
