...
function dxPopupMessage(text,ms,r1,g1,b1,r2,g2,b2,outside)
	...
	function popupMessage()
		...
		Text(text, 301 + 1, 40 + 1, 976 + 1, 40 + 1, tocolor(0, 0, 0, alpha2), fontScale, fontType, "center", "center", false, false, true, false, false)
		Text(text, 301, 40, 976, 40, tocolor(r2,g2,b2, alpha1), fontScale, fontType, "center", "center", false, false, true, false, false)
		--Rectangle(288, 470, 701, 81, tocolor(r1,g1,b1, alpha1), true)
		--Text(text, 301 + 1, 470 + 1, 976 + 1, 551 + 1, tocolor(0, 0, 0, alpha2), fontScale, fontType, "center", "center", false, false, true, false, false)
		--Text(text, 301, 470, 976, 551, tocolor(r2,g2,b2, alpha1), fontScale, fontType, "center", "center", false, false, true, false, false)
	end
